...
if not df_filtre.empty:
    ...
    config_col = {
            ...
            "Or": st.column_config.NumberColumn("🥇", width=40),
            "Argent": st.column_config.NumberColumn("🥈", width=40),
            "Bronze": st.column_config.NumberColumn("🥉", width=40),
            "Total": st.column_config.NumberColumn("Total", width=60, format="%d"),
